...
/*
  Set Tuya Module HeartBeat Timeout
  HeartBeat is always expected aprox. every 15s(15000ms)
  If heart beat is not found by "TY_MODULE_HB_TIMEOUT_H_ms" (ms), an error will be raised
  If a heart beat appears faster than "TY_MODULE_HB_TIMEOUT_L_ms" (ms), an error will be raised
*/

#define TY_MODULE_HB_TIMEOUT_H_ms 18000
#define TY_MODULE_HB_TIMEOUT_L_ms 5000
