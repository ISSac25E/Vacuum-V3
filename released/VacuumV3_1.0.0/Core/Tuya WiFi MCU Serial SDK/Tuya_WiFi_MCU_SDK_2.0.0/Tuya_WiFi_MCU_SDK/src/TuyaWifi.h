...
volatile unsigned char stop_update_flag; // ENABLE:Stop all data uploads   DISABLE:Restore all data uploads
...
private:
  ...
  volatile unsigned char wifi_work_state = WIFI_STATE_UNKNOWN;   // Wifi module current working status
#endif /* WIFI_CONTROL_SELF_MODE */
